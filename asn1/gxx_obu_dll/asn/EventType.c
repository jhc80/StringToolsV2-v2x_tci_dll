...
int
EventType_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
asn_TYPE_descriptor_t asn_DEF_EventType = {
	...
	sizeof(asn_DEF_EventType_tags_1)
		/sizeof(asn_DEF_EventType_tags_1[0]), /* 1 */
	{ &asn_OER_type_EventType_constr_1, &asn_PER_type_EventType_constr_1, EventType_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
