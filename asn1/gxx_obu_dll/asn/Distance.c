...
int
Distance_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_Distance_constr_1 CC_NOTUSED = {
	{ 2, 1 }	/* (0..50000) */,
	-1};
asn_per_constraints_t asn_PER_type_Distance_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_Distance = {
	...
	sizeof(asn_DEF_Distance_tags_1)
		/sizeof(asn_DEF_Distance_tags_1[0]), /* 1 */
	{ &asn_OER_type_Distance_constr_1, &asn_PER_type_Distance_constr_1, Distance_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
