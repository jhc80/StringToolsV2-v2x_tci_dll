...
asn_TYPE_member_t asn_MBR_PtcData_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PtcData, ptcType),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PtcData, ptcId),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PtcData, source),
	...
	{ ATF_POINTER, 1, offsetof(struct PtcData, id),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PtcData, secMark),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PtcData, pos),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PtcData, posConfidence),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PtcData, speed),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PtcData, heading),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PtcData, size),
...
static const int asn_MAP_PtcData_oms_1[] = { 3 };
static const ber_tlv_tag_t asn_DEF_PtcData_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PtcData_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 } /* size */
};
asn_SEQUENCE_specifics_t asn_SPC_PtcData_specs_1 = {
	sizeof(struct PtcData),
	offsetof(struct PtcData, _asn_ctx),
	asn_MAP_PtcData_tag2el_1,
	10,	/* Count of tags in the map */
	asn_MAP_PtcData_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	10,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_PtcData = {
	"PtcData",
	"PtcData",
	&asn_OP_SEQUENCE,
	asn_DEF_PtcData_tags_1,
	sizeof(asn_DEF_PtcData_tags_1)
		/sizeof(asn_DEF_PtcData_tags_1[0]), /* 1 */
	asn_DEF_PtcData_tags_1,	/* Same as above */
	sizeof(asn_DEF_PtcData_tags_1)
		/sizeof(asn_DEF_PtcData_tags_1[0]), /* 1 */
