...
/* Dependencies */
typedef enum DetectedPTCData__type_relatedExt_PR {
	DetectedPTCData__type_relatedExt_PR_NOTHING,	/* No components present */
	DetectedPTCData__type_relatedExt_PR_motorExt,
	DetectedPTCData__type_relatedExt_PR_non_motorExt
	/* Extensions may appear below */
	
} DetectedPTCData__type_relatedExt_PR;
...
typedef struct DetectedPTCData {
	...
	struct DetectedPTCData__type_relatedExt {
		DetectedPTCData__type_relatedExt_PR present;
