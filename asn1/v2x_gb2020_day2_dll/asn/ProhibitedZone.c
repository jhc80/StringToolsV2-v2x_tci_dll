...
static asn_SET_OF_specifics_t asn_SPC_non_motorVehicleProhibitedZones_specs_3 = {
	sizeof(struct ProhibitedZone__non_motorVehicleProhibitedZones),
	offsetof(struct ProhibitedZone__non_motorVehicleProhibitedZones, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_gridLineMarkingProhibitedZones_specs_5 = {
	sizeof(struct ProhibitedZone__gridLineMarkingProhibitedZones),
	offsetof(struct ProhibitedZone__gridLineMarkingProhibitedZones, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
