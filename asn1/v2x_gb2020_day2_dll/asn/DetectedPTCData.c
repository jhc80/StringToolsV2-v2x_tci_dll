...
static asn_TYPE_member_t asn_MBR_type_relatedExt_12[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DetectedPTCData__type_relatedExt, choice.motorExt),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DetectedPTCData__type_relatedExt, choice.non_motorExt),
...
static asn_CHOICE_specifics_t asn_SPC_type_relatedExt_specs_12 = {
	sizeof(struct DetectedPTCData__type_relatedExt),
	offsetof(struct DetectedPTCData__type_relatedExt, _asn_ctx),
	offsetof(struct DetectedPTCData__type_relatedExt, present),
	sizeof(((struct DetectedPTCData__type_relatedExt *)0)->present),
