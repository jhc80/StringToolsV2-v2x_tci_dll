...
static asn_SET_OF_specifics_t asn_SPC_coordinates_specs_6 = {
	sizeof(struct RoadsideCoordination__coordinates),
	offsetof(struct RoadsideCoordination__coordinates, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_laneCoordinates_specs_8 = {
	sizeof(struct RoadsideCoordination__laneCoordinates),
	offsetof(struct RoadsideCoordination__laneCoordinates, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
