...
int
StationOrGantryId_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
asn_TYPE_descriptor_t asn_DEF_StationOrGantryId = {
	...
	sizeof(asn_DEF_StationOrGantryId_tags_1)
		/sizeof(asn_DEF_StationOrGantryId_tags_1[0]), /* 1 */
