...
/*
** by chenxp, convert float to integer
*/
#define LUA_FLOORN2I 1 
typedef int(*LUA_ON_LOAD_LIBRARY)(void *L,const char *name, void *_hmodule);
typedef int(*LUA_ON_FREE_LIBRARY)(void *_hmodule);
extern LUA_ON_LOAD_LIBRARY lua_on_load_library_ptr;
extern LUA_ON_FREE_LIBRARY lua_on_free_library_ptr;
extern int lua_State_Size;
#include "lua_print.h"
