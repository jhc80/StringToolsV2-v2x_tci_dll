function ItsRoadPoint_to_lua(data)
    ...
    for i=1,_obj.attributesLocalPointCount,1 do
        _obj.attributesLocalPoint[i] = data:GetInt64();
    end
    data:Skip((MaxPointAttributesNum-_obj.attributesLocalPointCount)*SIZE_OF_INT64);
...
function lua_to_ItsRoadPoint(_obj,file)
    ...
    for i=1,_obj.attributesLocalPointCount,1 do
        file:PutInt64(_obj.attributesLocalPoint[i]);
    end
    file:FillBlock((MaxPointAttributesNum-_obj.attributesLocalPointCount)*SIZE_OF_INT64,0);
...
function ItsRoadPoint_size()
    ...
    _size = _size + MaxPointAttributesNum*SIZE_OF_INT64;  --attributesLocalPoint
    return _size;
end
