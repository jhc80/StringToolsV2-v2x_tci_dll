function ItsTimeCountingDown_to_lua(data)
    local _obj={};
    ...
    _obj.nextDuration = data:GetUInt32();
    return _obj;
end

function lua_to_ItsTimeCountingDown(_obj,file)
    ...
    file:PutUInt32(_obj.nextDuration);
end

function ItsTimeCountingDown_size()
    local _size = 0;
    ...
    _size = _size + SIZE_OF_UINT32;  --nextDuration
    return _size;
end
